...
## save weight with bfloat
def save_quantized_weights_with_bfloat(args, model, quantizers, sym = True):
    ...
    quantized_weights_path = os.path.join(args.exp_dir, f"quantized_weights_bfloat.pth")
